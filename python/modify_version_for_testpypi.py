...
# Set the version in pyproject.toml to the next unused version.
...
pyproject = cur_file.parent / "pyproject.toml"
...
modified_pyproject = version_re.sub(f'version = "{next_v}"', pyproject_data, 1)
